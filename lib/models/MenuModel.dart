...
final menuList = [
  ...
  const MenuModel(title: 'CTM', icon: Icons.airplanemode_active_outlined, route: '/ctm',color: Color(0xffF87CAD)),
  const MenuModel(title: 'Appraisals', icon: Icons.list, route: '/appraisal',color: Color(0xff86CAEA)),
