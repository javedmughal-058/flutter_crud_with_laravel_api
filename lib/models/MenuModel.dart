...
final menuList = [
  const MenuModel(title: 'Appointment', icon: Icons.list_alt, route: '/appointment_home',color: Color(0xffC1C2F6)),
  const MenuModel(title: 'DSS', icon: Icons.approval, route: '/dss_notifs',color: Color(0xff86CAEA)),
  const MenuModel(title: 'ESS', icon: Icons.time_to_leave, route: '/ess',color: Color(0xff74A1DF)),
  const MenuModel(title: 'Leave', icon: Icons.time_to_leave, route: '/leave_apply',color: Color(0xffFFA556)),
  const MenuModel(title: 'Garment', icon: Icons.shopping_cart_outlined, route: '/garment_request',color: Color(0xffAB729F)),
  ...
  const MenuModel(title: 'Settings', icon: Icons.settings, route: '/settings',color: const Color(0xffB175FF)),
  const MenuModel(title: 'About US', icon: Icons.info, route: '/about_us',color: const Color(0xffC1C2F6)),
];